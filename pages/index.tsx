	...
	return (
		...
		>
			<h5 className="my-3 font-medium">
				...
				development, data analysis &#38; visualization and data science applied
				to real estate. A self-starter and cheerleader at heart, I bring strong
				statistical, problem-solving and team-building skills, as well as
				reliability and determination to see projects through completion. My
				other interests include real estate and financial investments, graphic
				and interior design, long-distance running, ashtanga yoga and
				scuba-diving.
			</h5>
			<div
